...
public class HeatMapRepresentation : MonoBehaviour
{
    ...
    void DistributeWeights(InformationType informationType)
    {
        switch (informationType)
        {
            ...
            case InformationType.POSITION:
                ...
                {
                    //Esta linea es una guarrada pq en el punto de spawn inicial se acumula demasiado peso y as?se hace una mayor distinción de colores en el resto del mapa
    ...
    void GenerateHeatMap()
    {
        ...
        for (int x = 0; x < gridArray.GetLength(0) / grid.cellSize.x; x++)
        {
            ...
            {
                if (gridArray[x, y].weight <= threshold)
                    continue;
